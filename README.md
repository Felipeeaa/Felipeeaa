...
## 👤 Sobre mí & Enfoque Profesional

Soy un desarrollador de software con una sólida base analítica. Mi experiencia previa en electromecánica me aportó una capacidad metódica superior para la resolución de problemas críticos, habilidad que hoy aplico en arquitecturas de software y entornos corporativos de alta exigencia.

* 🏢 **Actualidad:** Realizando mis prácticas profesionales en **BBVA Technology**, inmerso en operativas críticas, gestión de procesos y desarrollo multiplataforma.
* 🎯 **Criterio Técnico:** Foco en código limpio, escalabilidad, automatización de procesos y persistencia de datos segura.
* 🚀 **Objetivo:** Consolidar mi carrera profesional aportando valor en el desarrollo backend, integración de sistemas y cloud.
